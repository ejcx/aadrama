-- Fix intermittent skill-based team assignment:
-- - Replace temp-table loop (fails on reused pooler sessions: "relation already exists")
-- - Single set-based query for 100 trials
-- - Idempotent when scrim already started
-- - SECURITY DEFINER so any ready player can start the scrim
