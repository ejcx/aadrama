...
export const TIERED_MAPS: readonly TieredMapEntry[] = [
  ...
  { name: 'Pipeline', tier: 1, relativeWeight: 11 },
  { name: 'Weapons Cache', tier: 1, relativeWeight: 8 },
  ...
  { name: 'SF Sandstorm', tier: 2, relativeWeight: 5 },
  ...
  { name: 'Woodland Outpost', tier: 2, relativeWeight: 1 },
  // Tier 3
  ...
  { name: 'District', tier: 3, relativeWeight: 2.5 },
  { name: '[AA3] Impact', tier: 3, relativeWeight: 2.5 },
