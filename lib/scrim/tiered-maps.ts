...
export const TIERED_MAPS: readonly TieredMapEntry[] = [
  ...
  { name: 'Pipeline', tier: 1, relativeWeight: 12 },
  { name: 'Weapons Cache', tier: 1, relativeWeight: 9 },
  { name: 'Collapsed Tunnel', tier: 1, relativeWeight: 8 },
  ...
  { name: 'SF Sandstorm', tier: 2, relativeWeight: 6 },
  { name: 'SF CSAR', tier: 2, relativeWeight: 2 },
  { name: 'Dusk', tier: 2, relativeWeight: 1 },
  { name: 'River Basin', tier: 2, relativeWeight: 1 },
  { name: 'Canyon', tier: 2, relativeWeight: 7.5 },
  { name: 'Woodland Outpost', tier: 2, relativeWeight: 5 },
  // Tier 3
  { name: 'Mountain Pass SE', tier: 3, relativeWeight: 0.5 },
  ...
  // Tier 4
  { name: 'Weapons Cache SE', tier: 4, relativeWeight: 0.4 },
  { name: 'SF Hospital', tier: 4, relativeWeight: 0.4 },
  { name: 'SF Dockside', tier: 4, relativeWeight: 0.2 },
  { name: 'Swamp Raid', tier: 4, relativeWeight: 0.4 },
  { name: 'SF Oasis', tier: 4, relativeWeight: 0.1 },
  ...
  { name: 'Rummage', tier: 5, relativeWeight: 0.2 },
...
export const TIERED_MAPS_6V6: readonly TieredMapEntry[] = [
  // Tier 1
  { name: 'Insurgent Camp', tier: 1, relativeWeight: 10 },
  { name: 'Urban Assault', tier: 1, relativeWeight: 10 },
  { name: 'MOUT McKenna', tier: 1, relativeWeight: 10 },
  { name: 'Mountain Ambush', tier: 1, relativeWeight: 5 },
  { name: 'SF Sandstorm', tier: 1, relativeWeight: 10 },
  { name: 'Dusk', tier: 1, relativeWeight: 12 },
  { name: 'Canyon', tier: 1, relativeWeight: 12 },
  { name: 'Woodland Outpost', tier: 1, relativeWeight: 10 },
  { name: 'Weapons Cache SE', tier: 1, relativeWeight: 5 },
  // Tier 2
  // { name: 'SF CSAR', tier: 2, relativeWeight: 2 },
  { name: 'River Basin', tier: 2, relativeWeight: 3 },
  { name: 'Mountain Pass SE', tier: 2, relativeWeight: 3 },
  { name: 'Border', tier: 2, relativeWeight: 3 },
  { name: 'SF Hospital', tier: 2, relativeWeight: 2 },
  { name: 'SMU GH RiverVillage', tier: 2, relativeWeight: 1.2 },
  // Tier 3
  { name: 'Headquarters Raid', tier: 3, relativeWeight: 1 },
  { name: 'Bridge SE', tier: 3, relativeWeight: 1.1 },
  { name: 'JRTC Farm Raid', tier: 3, relativeWeight: 1 },
  { name: 'District', tier: 3, relativeWeight: 2 },
  { name: '[AA3] Impact', tier: 3, relativeWeight: 3 },
  ...
  { name: 'Swamp Raid', tier: 4, relativeWeight: 0.5 },
  { name: 'SF Oasis', tier: 4, relativeWeight: 0.2 },
  { name: 'SF PCR', tier: 4, relativeWeight: 0.5 },
  { name: 'SF Village', tier: 4, relativeWeight: 0.2 },
  { name: 'SMU GH SFOldTown', tier: 4, relativeWeight: 0.5 },
  { name: 'SF Blizzard', tier: 4, relativeWeight: 0.5 },
  // Tier 5
  { name: 'Pipeline', tier: 5, relativeWeight: 0.2 },
  { name: 'Weapons Cache', tier: 5, relativeWeight: 0.2 },
  { name: 'Collapsed Tunnel', tier: 5, relativeWeight: 0.2 },
  { name: 'SF Courtyard', tier: 5, relativeWeight: 0.2 },
  { name: 'SF Taiga', tier: 5, relativeWeight: 0.2 },
  { name: 'Rummage', tier: 5, relativeWeight: 0.05 },
  // { name: 'Pipeline SF', tier: 5, relativeWeight: 0.2 },
  // { name: 'Bridge Crossing', tier: 5, relativeWeight: 0.1 },
  // Tier 6 (FLS assault omitted — 0% in spreadsheet)
  { name: 'Radio Tower', tier: 6, relativeWeight: 0.05 },
